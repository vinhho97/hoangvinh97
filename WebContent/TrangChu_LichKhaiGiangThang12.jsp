				...
				<div class= "col-sm-8" style="margin-left:0%;">
					...
					<div class= "container-fluid">
						...
						<div class="panel-body" style="width: 100%;">
							<h3><font face="Times New Roman">LỊCH KHAI GIẢNG CÁC LỚP TIN HỌC NGẮN HẠN THÁNG 12.2017</font></h3>
						</div>
						</div>
						<div style="width: 100%; margin-top: -3%;margin-left :0px;">
						<img  src = "img/TrangChu_LichKhaiGiang_Thang12.png">						
						</div>
				</div>
				</div>
				</div>
					...
					<div class="panel panel-default">
						...
						<div class= "panel-body">
							<ul style="margin-left:-10%;">
								<li><small><a href="http://localhost:8080/TrangChu_DongSuKien_HoiThaoIOT.jsp" title="Lịch thi và danh sách phòng thi lớp CNTT cơ bản CB25, CB26 ngày 29/10/2017.">HỘI THẢO : KHỞI ĐỘNG CUỘC THI IOT VIETNAM 2017
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-sm-8">
					...
					<ul class="older">                                                                                                   
                <li><small><a href="http://itute.ocs.opusinteractive.io/TrangChu_LichKhaiGiangThang12.jsp">LỊCH KHAI GIẢNG CÁC LỚP TIN HỌC NGẮN HẠN THÁNG 12.2017.</a>
											</small></li>
										<li><small><a href="http://itute.ocs.opusinteractive.io/TrangChu_LichKhaiGiangThietKeDoHoa2D.jsp">LỊCH KHAI GIẢNG CÁC LỚP THIẾT KẾ ĐỒ HỌA 2D
											</a></small></li>
										<li><small><a href="http://itute.ocs.opusinteractive.io/TrangChu_LichKhaiGiangThietKeWebsite.jsp">LỊCH KHAI GIẢNG THIẾT KẾ WEBSITE
											</a></small></li>
										<li><small><a href="http://itute.ocs.opusinteractive.io/TrangChu_LichKhaiGiangTinHocChuanQuocTeMOSExcel.jsp">LỊCH KHAI GIẢNG TIN HỌC CHUẨN QUỐC TẾ</a>
											</small></li>
										<li><small><a href="http://itute.ocs.opusinteractive.io/TrangChu_LichKhaiGiangTinHocCoBan.jsp">LỊCH KHAI GIẢNG CÁC LỚP TIN HỌC CƠ BẢN
											</a></small></li>  
                      </ul>					
                      </div>
					</div>
