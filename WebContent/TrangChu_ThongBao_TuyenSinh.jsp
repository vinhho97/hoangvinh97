				...
				<div class= "col-sm-8" style="margin-left:0%;">
					...
					<div class= "container-fluid">
						...
						<div class="panel-body" style="width: 100%;">
							<h3><font face="Times New Roman">THÔNG BÁO TUYỂN SINH CÁC LỚP “ỨNG DỤNG CÔNG NGHỆ THÔNG TIN CƠ BẢN” THÁNG 12/2017<br></font></h3>
						</div>
						</div>
						<div style="width: 100%; margin-top: 0%;margin-left :0px;">
						<img  src = "img/ThongBao_TuyenSinh1.PNG">						
						</div>
				</div>
				</div>
				</div>
