				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								<a class="active">Danh sách học viên</a>
							</li>
								...
								<div class="col-xs-12">
									...
									<div class="row">
										<div class="col-xs-12">
											...
											<div class="row">
												<div class="col-xs-6">
											 <button type="button" class="btn btn-default btn-lg" id="myBtn">Thêm Học Viên</button>
												</div>
												<div class="col-xs-6">
													<div class="dataTables_paginate paging_simple_numbers" id="dynamic-table_paginate">
														<ul class = "pagination">
														 	...
														 	<c:if test="${numberpage == 1}">
															   ...
															   <li><a href = "QuanLyHocVienController?pageid=1">1</a></li>
															   <li><a href = "QuanLyHocVienController?pageid=2">2</a></li>
															   <li><a href = "QuanLyHocVienController?pageid=${numberpage+1}">&raquo;</a></li>
														   </c:if>
														   <c:if test="${numberpage == maxpageid}">
															   <li><a href = "QuanLyHocVienController?pageid=${numberpage-1}">&laquo;</a></li>
															   <li><a href = "QuanLyHocVienController?pageid=1">1</a></li>
															   <li><a href = "QuanLyHocVienController?pageid=2">2</a></li>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header" style="padding:35px 50px;">
          ...
          <h4><span class="glyphicon glyphicon-lock"></span> Thêm Học Viên</h4>
        </div>
        <div class="modal-body" style="padding:40px 50px;">
          <form role="form">
            <div class="form-group">
              <label for="usrname"><span class="glyphicon glyphicon-user"></span> ID</label>
              <input type="text" class="form-control" id="usrname" placeholder="Nhập vào mã học viên">
            </div>
            <div class="form-group">
              <label for="psw"><span class="glyphicon glyphicon-eye-open"></span> Họ Tên</label>
              <input type="text" class="form-control" id="psw" placeholder="Nhập vào họ tên">
            </div>
            <div class="form-group">
              <label for="usrname"><span class="glyphicon glyphicon-user"></span> Giới Tính</label>
             <label>
            ...
            <div class="form-group">
              <label for="usrname"><span class="glyphicon glyphicon-user"></span> Điện Thoại</label>
				 <input type="text" class="form-control" id="psw" placeholder="Nhập vào điện thoại">
				
            </div>
            <div class="form-group">
                 <label for="usrname"><span class="glyphicon glyphicon-user"></span>Ngày Sinh</label>
                       <input name="NgaySinh" type="date" id="birthDate" class="form-control">
            </div> 
            <div class="form-group">
              <label for="usrname"><span class="glyphicon glyphicon-user"></span> Email</label>
              <input type="text" class="form-control" id="usrname" placeholder="Nhập vào email">
            </div>
            <div class="form-group">
              <label for="usrname"><span class="glyphicon glyphicon-user"></span> Địa Chỉ</label>
              <input type="text" class="form-control" id="usrname" placeholder="Nhập vào địa chỉ">
            </div>
