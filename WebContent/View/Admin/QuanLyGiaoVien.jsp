...
<title>Quản lý danh sách giáo viên</title>
		
		<link rel="stylesheet" href="Backend/assets/css/bootstrap.min.css" />
		
		<!-- font -->
		<link rel="stylesheet" href="Backend/font/font-awesome.min.css" />
		<link rel="stylesheet" href="Backend/assets/font-awesome/4.5.0/css/font-awesome.min.css" />

		
		<link rel="stylesheet" href="Backend/assets/css/colorbox.min.css" />
...
<body class="no-skin">	
	<!-- Header -->
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								<a class="active">Danh sách giáo viên</a>
							</li>
		...
		<script src="Backend/assets/js/dataTables.buttons.min.js"></script>
		<script src="Backend/assets/js/buttons.flash.min.js"></script>
		<script src="Backend/assets/js/buttons.html5.min.js"></script>
		<script src="Backend/assets/js/buttons.print.min.js"></script>
		<script src="Backend/assets/js/buttons.colVis.min.js"></script>
