...
<div class="container-fluid">
	...
	<div class="panel panel-default">
			<table id="tableSV" style="width: 100%;" >
				<tr  style="height: 40px; background:  #f1f1f1;">
					...
					<td style="  border: 1px solid #c0c0c0;text-align: center;">
						<p style="margin-top: 10px;"><strong>Tên khóa học </strong></p>
					</td>
					<td style="  border: 1px solid #c0c0c0;text-align: center;">
				...
				<c:forEach items = "${listStudents}" var= "l">
				<tr  style="height: 40px; backgroud: #438EB9;">
					...
					<td style="width: 10%;	border: 1px solid #c0c0c0;">
						&nbsp;&nbsp;&nbsp;<a href="ThuKy_XetPheDuyetController?studentID=${l.studentID}&user=${DangNhap.userName}&pass=${DangNhap.passWord}">Phê Duyệt</a>
					</td>
				</tr>
			</c:forEach>		
			</table> 			
