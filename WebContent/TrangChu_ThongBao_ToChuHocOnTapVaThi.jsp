				...
				<div class= "col-sm-8" style="margin-left:0%;">
					...
					<div class= "container-fluid">
						...
						<div class="panel-body" style="width: 100%;">
							<h3><font face="Times New Roman">THÔNG BÁO VỀ VIỆC TỔ CHỨC HỌC, ÔN TẬP VÀ THI CẤP CHỨNG "KỸ NĂNG TIN HỌC UTE-CHUẨN IC3" CHO SINH VIÊN HỆ TỪ XA TRƯỜNG ĐẠI HỌC SƯ PHẠM KỸ THUẬT THÀNH PHỐ HỒ CHÍ MINH ĐỢT 1 NĂM 2018 <br>
							</font></h3>
						</div>
						</div>
						<div style="width: 100%; margin-top: 0%;margin-left :0px;">
						<img  src = "img/ThongBao_ToChuHocOnTapVaThi1.PNG">	
						<img  src = "img/ThongBao_ToChuHocOnTapVaThi2.PNG">	
						<img  src = "img/ThongBao_ToChuHocOnTapVaThi3.PNG">	
						<img  src = "img/ThongBao_ToChuHocOnTapVaThi4.PNG">						
						</div>
				</div>
				</div>
				</div>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-sm-8">
					...
					<ul class="older">                                                                                                   
                <li><small><a href="http://itute.ocs.opusinteractive.io/TrangChu_ThongBao_ToChuHocOnTapVaThi.jsp">
											THÔNG BÁO VỀ VIỆC TỔ CHỨC HỌC,ÔN TẬP VÀ THI CẤP CHỨNG CHỈ "KỸ NĂNG TIN HỌC UTE-CHUẨN IC3" CHO SINH VIÊN HỆ TỪ XA TRƯỜNG ĐAỊ HỌC SƯ PHẠM KỸ THUẬT THÀNH PHỐ HỒ CHÍ MINH ĐỢT 1 NĂM 2018</a></small></li>
										<li><small><a href="http://itute.ocs.opusinteractive.io/TrangChu_ThongBao_TuyenSinh.jsp">THÔNG BÁO TUYỂN SINH CÁC LỚP ỨNG DỤNG CÔNG NGHỆ THÔNG TIN CƠ BẢN THÁNG 12 NĂM 2017</a>										
											</small></li>
										<li><small><a href="http://itute.ocs.opusinteractive.io/TrangChu_ThongBao_SatHachCNTT.jsp">THÔNG BÁO SÁT HẠCH CHUẨN CNTT CƠ BẢN THÁNG 10 NĂM 2017
											</a></small></li> 
                      </ul>					
                      </div>
					</div>
