...
@WebServlet("/ThuKyDoiMatKhauController")
public class ThuKyDoiMatKhauController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       

    public ThuKyDoiMatKhauController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = request.getRequestDispatcher("View/ThuKy/ThuKyDoiMatKhau.jsp");
